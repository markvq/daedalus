...
let
  ...
  appImage = makeAppImage {
    ...
    buildInputs = [ unzip pax-utils patchelf ];
    buildCommand = ''
      mkdir -p $out
      ...
      unzip -d $out/electron ${electron3.src}
      ...
      ln -s usr/share/icons/*/64x64/apps/*.png $out/Daedalus-Cardano-SL.png
    '';
  };
